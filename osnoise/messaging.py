...
class BasicPublisher(object):
    ...
    def __init__(self, conf):
        ...
        self.message_type       = conf.dummy_conf.message_type
        self.priority           = conf.dummy_conf.priority
        self.delivery_mode      = conf.dummy_conf.delivery_mode
        self.message_encoding   = conf.dummy_conf.message_encoding
